...
interface FrequencyDetectorState {
    prevPhase: number;
}

const FrequencyDetectorPlugin = {
    ...
    processor: {
        states: new Map<string, FrequencyDetectorState>(),
        ...
        process(inputs: (Float32Array | null)[], params: Record<string, unknown>, chunkSize: number, nodeId: string): Float32Array {
            ...
            const bandwidth = (params.bandwidth ?? 100) as number;
...
export default FrequencyDetectorPlugin satisfies PluginDefinition;
